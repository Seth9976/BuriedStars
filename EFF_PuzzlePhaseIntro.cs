...
public class EFF_PuzzlePhaseIntro : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		foreach (Text text in textMain)
		{
			if (text != null)
			{
				text.text = GameGlobalUtil.GetXlsProgramText("EFF_PUZZLEPHASE_INTRO_MAIN");
			}
		}
		if (m_textSub != null)
		{
			m_textSub.text = GameGlobalUtil.GetXlsProgramText("EFF_PUZZLEPHASE_INTRO_SUB");
		}
