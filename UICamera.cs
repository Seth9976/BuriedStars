...
public class UICamera : MonoBehaviour
{
	...
	public void ProcessTouch(bool pressed, bool released)
	{
		...
		if (currentTouch.pressed != null)
		{
			...
			if (currentTouch.pressed == currentTouch.current && mTooltipTime != 0f && currentTouch.clickNotification != ClickNotification.None && !currentTouch.dragStarted && currentTouch.deltaTime > tooltipDelay)
			{
				mTooltipTime = 0f;
				currentTouch.clickNotification = ClickNotification.None;
				if (longPressTooltip)
