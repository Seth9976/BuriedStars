...
public class UIInput : MonoBehaviour
{
	...
	public virtual bool ProcessEvent(Event ev)
	{
		...
		bool flag = ((platform != RuntimePlatform.OSXEditor && platform != RuntimePlatform.OSXPlayer) ? ((ev.modifiers & EventModifiers.Control) != 0) : ((ev.modifiers & EventModifiers.Command) != 0));
